...
const ManageStudents = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFF] font-sans pb-32 relative">
      ...
      {/* WHITE HEADER STRIP */}
      <div className="bg-white border-b border-slate-200 shadow-[0_2px_15px_rgba(0,0,0,0.02)] mb-8 top-0 sticky z-40">
        <div className="max-w-[1700px] mx-auto px-4 md:px-6 py-4 animate-in fade-in slide-in-from-top-1 duration-700">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <Link
                  to="/admin"
                  className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-[#7e7e7e] hover:text-cyan-600 transition group w-fit mb-1"
                >
                  <FaArrowLeft size={12} className="group-hover:-translate-x-1 transition-transform" /> Back to Dashboard
                </Link>
                ...
                <p className="text-[10px] font-bold text-[#7e7e7e] mt-1">View and manage all registered students</p>
              </div>
            </div>
